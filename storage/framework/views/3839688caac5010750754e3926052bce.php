...
<head>
    ...
    <title>Data Posts - Manajemen Basis Data</title>
...
<body style="background: lightgray">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Create Read Update Delete</h3>
                    <h5 class="text-center">Manajemen Basis Data</h5>         
                    <hr>
                </div>
...
</html><?php /**PATH C:\MBD\resources\views/posts/index.blade.php ENDPATH**/ ?>